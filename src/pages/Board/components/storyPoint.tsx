        ...
        <div className=" sticky top-0 grid gap-3">
          ...
          <div className="grid gap-3 py-1">
            <div className="grid items-center gap-4">
              ...
              <Input disabled className="peer z-0  cursor-auto bg-transparent ring-1" placeholder={storyPoint} />
            </div>
            <div className="grid grid-cols-7  gap-3">
              <div className="col-span-1 items-center">
              ...
              <div className="col-span-3 col-end-6 items-center rounded-md border border-destructive text-destructive">
                <Button onClick={() => setStoryPoint('')} variant="outline" className="w-full">
                  Remove
                </Button>
              </div>
            </div>
