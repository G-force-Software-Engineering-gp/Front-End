...
import scheduleDark from '../../pics/scheduleDark.png';
import scheduleLight from '../../pics/scheduleLight.png';
  ...
  return (
    <div data-testid="homepageSidebar" className={cn('pb-12', 'hidden lg:block')}>
      <div className="space-y-4 py-4">
        ...
        <div>
          {theme === 'dark' ? (
            <img className="my-20 h-[400px]" src={scheduleDark} alt="" />
          ) : (
            <img className="my-20 h-[400px] " src={scheduleLight} alt="" />
          )}
        </div>
      </div>
    </div>
