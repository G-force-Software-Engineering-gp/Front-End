  ...
  return (
    <div className=" px-6 pt-3">
      ...
      <div>
        ...
        {/* Workspaces */}
        <div className="mt-4">
          <div className="sm:flex grid sm:items-center sm:justify-between">
            ...
            <div className="">
              <Button variant="secondary" className="mr-1 p-2 mt-1 sm:mt-0">
                {' '}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
              ...
              <Button variant="secondary" className="p-2 mt-1 sm:mt-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <div className="mb-8 mt-4 grid auto-rows-fr sm:grid-cols-2 gap-2">
            ...
            <Card className=" cursor-pointer bg-slate-300 dark:bg-slate-800">
              <div className=" gap-4 space-y-0 flex sm:py-9 py-10 sm:px-20 px-12">
