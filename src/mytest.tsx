...
function MyTest() {
  ...
  <AspectRatio ratio={16 / 9}>
    <img src="https://ui.shadcn.com/_next/image?url=https%3A%2F%2Fimages.unsplash.com%2Fphoto-1588345921523-c2dcdb7f1dcd%3Fw%3D800%26dpr%3D2%26q%3D80&w=2048&q=75" alt="Image" className="rounded-md object-cover" />
  </AspectRatio>
...
<div className="flex items-center space-x-4">
    ...
    <Tabs defaultValue="account" className="w-[400px]">
      ...
      <TabsContent value="password">
        ...
        <CommandDialogDemo />
        {/* <ShadCalendar mode="single" selected={date} onSelect={setDate} className="rounded-md border" /> */}
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant={'outline'}
